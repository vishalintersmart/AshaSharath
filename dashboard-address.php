            ...
            <div class="MainSide">
                <div class="MainSideBox">
                    <div class="TitleSec">
                        ...
                        <a href="#" class="add-btn" data-bs-toggle="modal" data-bs-target="#newAddress">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 53.4 53.4">
                                <circle class="st0" cx="26.7" cy="26.7" r="26.2" />
                                <g>
                                    <path d="M28.4,13.9v12.6h12.2v3.2H28.4v12.8H25V29.8H12.8v-3.2H25V13.9H28.4z" />
                                </g>
                            </svg>
                            Add New Address
                        </a>
                    ...
                    <div class="addresslist">
                        <ul>
                            <li>
                                <label for="item1" class="address">
                                    <div class="AddrsBox">
                                        <div class="DetlBox">
                                            <div class="BoxHeader">
                                                <div class="AddressCat">Home</div>
                                            ...
                                            <div class="location">
                                                ...
                                                <p>
                                                    Rolex Apartment No2, Building, Street,
                                                    UAE Emirate
                                                </p>
                                            </div>
                                        </div>
                            ...
                            <li>
                                <label for="item1" class="address">
                                    <div class="AddrsBox">
                                        <div class="DetlBox">
                                            <div class="BoxHeader">
                                                <div class="AddressCat">Office</div>
                                                <div class="button-box">
                                                    <svg id="edit" viewBox="0 0 511.984 511.984" data-bs-toggle="modal"
                                                        data-bs-target="#newAddress">
                                                        <path
                            ...
                            <li>
                                <label for="item1" class="address">
                                    <div class="AddrsBox">
                                        <div class="DetlBox">
                                            <div class="BoxHeader">
                                                <div class="AddressCat">Parent's House</div>
                                                <div class="button-box">
                                                    <svg id="edit" viewBox="0 0 511.984 511.984" data-bs-toggle="modal"
                                                        data-bs-target="#newAddress">
                                                        <path
                            ...
                            <li>
                                <label for="item1" class="address">
                                    <div class="AddrsBox">
                                        <div class="DetlBox">
                                            <div class="BoxHeader">
                                                <div class="AddressCat">Home town</div>
                                                <div class="button-box">
                                                    <svg id="edit" viewBox="0 0 511.984 511.984" data-bs-toggle="modal"
                                                        data-bs-target="#newAddress">
                                                        <path
...
<div class="modal fade newaddress ComnModal" id="newAddress" tabindex="-1"
            ...
            <div class="modal-body">
                <form action="" method="post">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <textarea name="Address" id="Address" placeholder="Address" class="form-control" cols="30" rows="10"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="BtnSec">
